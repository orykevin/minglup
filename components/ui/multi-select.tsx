  ...
  (
    ...
    return (
      ...
      >
        <div
          className={cn(
            "flex items-start justify-between rounded-md border border-border px-3 py-2 text-base ring-offset-background focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2 md:text-sm",
            {
